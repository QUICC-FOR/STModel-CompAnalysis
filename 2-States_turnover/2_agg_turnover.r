...
files <- list.files('~/Documents/GitHub/STModel-CompAnalysis/out/',full.names=TRUE,recursive=TRUE,pattern='overlay_rs')
...
load("/home/steve/Documents/GitHub/STModel-Wrapper/inputs/shp/altBorder.robj")
...
brk <- 100
st_transitions[st_transitions[]>=0.30] <- 0.30
